	...
	<table class="table table-bordered">
		...
		<tbody>
			<tr>
				...
				<td>
                                    <a href="<?= base_url('Admin/User/editUser/' . $row['user_id']); ?>" class="btn btn-info" >Edit</a>
                                    <a href="<?= base_url('Admin/User/deleteUser/' . $row['user_id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure want to delete?')">Delete</a>
                                </td>
			</tr>
		</tbody>
	<?php } ?>
