            ...
            <div class="flex mt-[4.7rem] md:mt-0">
                ...
                <nav class="side-nav">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url('employee-dashboard'); ?>" class="side-menu">
                                <div class="side-menu__icon">
                                    <i data-lucide="shopping-bag"></i>
                                </div>
                                <div class="side-menu__title">
                         ...
                         <ul class="">
                            <li>
                                <a href="<?php echo base_url('list-category'); ?>" class="side-menu">
                                    <div class="side-menu__icon">
                                        <i data-lucide="activity"></i>
                                    </div>
                                    <div class="side-menu__title">
                    ...
                    <li>
                        <a href="<?php echo base_url('clients-logs'); ?>" class="side-menu">
                            <div class="side-menu__icon">
                                <i data-lucide="users"></i>
                            </div>
                            <div class="side-menu__title">
